...
class ci_detallecontrato extends sagep_ci
{
	...
	function evt__form_ml_detalle__modificacion($datos)
	{
		...
		$datos = $this->cn()->get_detalle(); // Con esto se obtienen todos los registros que no son de baja
	...
	function evt__form_ml_ubicacion__modificacion($datos)
	{
		...
		$datos = $this->cn()->get_ubicacion(); // Con esto se obtienen todos los registros que no son de baja
