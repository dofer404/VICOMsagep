...
class ci_provincias extends sagep_ci
{
		...
		try {
			...
			if (adebug::$debug) {
				...
				if ($sql_state == 'db_23505') {
					throw new toba_error_usuario('Ya existe la Provincia');
				}
			}
		}
	}
	...
	function conf__cuadro(sagep_ei_cuadro $cuadro)
	{
		...
		if (isset($this->s__datos_filtro)) {
			...
			$datos = dao_provincias::get_listado_provincias($sql_where);
